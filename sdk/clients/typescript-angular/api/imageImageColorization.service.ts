...
export class ImageImageColorizationService {
    ...
    public applyImageImageColorizationPost(image: Blob, model?: 'deoldify-artistic' | 'deoldify-stable', observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<object>(`${this.configuration.basePath}/image/image/colorization/`,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getVersionsImageImageColorizationGet(observe?: 'body', reportProgress?: boolean): Observable<object>;
    public getVersionsImageImageColorizationGet(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<object>>;
    public getVersionsImageImageColorizationGet(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<object>>;
    public getVersionsImageImageColorizationGet(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<object>(`${this.configuration.basePath}/image/image/colorization/`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
