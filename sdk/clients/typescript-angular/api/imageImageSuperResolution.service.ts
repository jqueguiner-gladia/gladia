...
export class ImageImageSuperResolutionService {
    ...
    public applyImageImageSuperResolutionPost(image: Blob, model?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<object>(`${this.configuration.basePath}/image/image/super-resolution/`,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getVersionsImageImageSuperResolutionGet(observe?: 'body', reportProgress?: boolean): Observable<object>;
    public getVersionsImageImageSuperResolutionGet(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<object>>;
    public getVersionsImageImageSuperResolutionGet(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<object>>;
    public getVersionsImageImageSuperResolutionGet(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<object>(`${this.configuration.basePath}/image/image/super-resolution/`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
