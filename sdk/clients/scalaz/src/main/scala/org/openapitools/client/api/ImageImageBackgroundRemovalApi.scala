...
object ImageImageBackgroundRemovalApi {
  ...
  def getVersionsImageImageBackgroundRemovalGet(host: String): Task[Any] = {
    implicit val returnTypeDecoder: EntityDecoder[Any] = jsonOf[Any]
...
class HttpServiceImageImageBackgroundRemovalApi(service: HttpService) {
  ...
  def getVersionsImageImageBackgroundRemovalGet(): Task[Any] = {
    implicit val returnTypeDecoder: EntityDecoder[Any] = jsonOf[Any]
