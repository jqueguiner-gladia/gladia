...
export class TextTextEntityExtractionApi extends BaseAPI {
     ...
     */
    applyTextTextEntityExtractionPost(requestParameters: ApplyTextTextEntityExtractionPostRequest): Observable<object> {
     ...
     */
    getVersionsTextTextEntityExtractionGet(): Observable<object> {
        const queryParameters: HttpQuery = {};
