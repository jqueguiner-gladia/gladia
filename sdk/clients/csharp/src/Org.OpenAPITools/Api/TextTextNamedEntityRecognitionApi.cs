...
namespace Org.OpenAPITools.Api
{
    ...
    /// </summary>
    public interface ITextTextNamedEntityRecognitionApi : IApiAccessor
    {
    ...
    public partial class TextTextNamedEntityRecognitionApi : ITextTextNamedEntityRecognitionApi
    {
        ...
        /// <returns></returns>
        public TextTextNamedEntityRecognitionApi(Org.OpenAPITools.Client.Configuration configuration = null)
        {
        ...
        {
             ApiResponse<Object> localVarResponse = ApplyTextTextNamedEntityRecognitionPostWithHttpInfo(text, model);
        ...
        /// <param name="model"> (optional, default to dbmdz-bert-large-cased-finetuned-conll03-english)</param>
        /// <returns>ApiResponse of Object</returns>
        public ApiResponse< Object > ApplyTextTextNamedEntityRecognitionPostWithHttpInfo (string text = null, string model = null)
        {

            var localVarPath = "/text/text/named-entity-recognition/";
            ...
            {
                Exception exception = ExceptionFactory("ApplyTextTextNamedEntityRecognitionPost", localVarResponse);
        ...
        {
             ApiResponse<Object> localVarResponse = await ApplyTextTextNamedEntityRecognitionPostAsyncWithHttpInfo(text, model);
             return localVarResponse.Data;
        ...
        /// <param name="model"> (optional, default to dbmdz-bert-large-cased-finetuned-conll03-english)</param>
        /// <returns>Task of ApiResponse (Object)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> ApplyTextTextNamedEntityRecognitionPostAsyncWithHttpInfo (string text = null, string model = null)
        {
        ...
        {
             ApiResponse<Object> localVarResponse = GetVersionsTextTextNamedEntityRecognitionGetWithHttpInfo();
             return localVarResponse.Data;
        }
        ...
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of Object</returns>
        public ApiResponse< Object > GetVersionsTextTextNamedEntityRecognitionGetWithHttpInfo ()
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetVersionsTextTextNamedEntityRecognitionGet", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        {
             ApiResponse<Object> localVarResponse = await GetVersionsTextTextNamedEntityRecognitionGetAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (Object)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> GetVersionsTextTextNamedEntityRecognitionGetAsyncWithHttpInfo ()
        {
