...
namespace Org.OpenAPITools.Api
{
    ...
    /// </summary>
    public interface ITextTextNextSentencePredictionApi : IApiAccessor
    {
    ...
    public partial class TextTextNextSentencePredictionApi : ITextTextNextSentencePredictionApi
    {
        ...
        /// <returns></returns>
        public TextTextNextSentencePredictionApi(Org.OpenAPITools.Client.Configuration configuration = null)
        {
        ...
        {
             ApiResponse<Object> localVarResponse = ApplyTextTextNextSentencePredictionPostWithHttpInfo(sentence1, sentence2, model);
        ...
        /// <param name="model"> (optional, default to bert-base-uncased)</param>
        /// <returns>ApiResponse of Object</returns>
        public ApiResponse< Object > ApplyTextTextNextSentencePredictionPostWithHttpInfo (string sentence1 = null, string sentence2 = null, string model = null)
        {

            var localVarPath = "/text/text/next-sentence-prediction/";
            ...
            {
                Exception exception = ExceptionFactory("ApplyTextTextNextSentencePredictionPost", localVarResponse);
        ...
        {
             ApiResponse<Object> localVarResponse = await ApplyTextTextNextSentencePredictionPostAsyncWithHttpInfo(sentence1, sentence2, model);
             return localVarResponse.Data;
        ...
        /// <param name="model"> (optional, default to bert-base-uncased)</param>
        /// <returns>Task of ApiResponse (Object)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> ApplyTextTextNextSentencePredictionPostAsyncWithHttpInfo (string sentence1 = null, string sentence2 = null, string model = null)
        {
        ...
        {
             ApiResponse<Object> localVarResponse = GetVersionsTextTextNextSentencePredictionGetWithHttpInfo();
             return localVarResponse.Data;
        }
        ...
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of Object</returns>
        public ApiResponse< Object > GetVersionsTextTextNextSentencePredictionGetWithHttpInfo ()
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetVersionsTextTextNextSentencePredictionGet", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        {
             ApiResponse<Object> localVarResponse = await GetVersionsTextTextNextSentencePredictionGetAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (Object)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> GetVersionsTextTextNextSentencePredictionGetAsyncWithHttpInfo ()
        {
