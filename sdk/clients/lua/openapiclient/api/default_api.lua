...
function default_api:read_users_image_image_uncolorization_users_get()
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
		path = string.format("%s/image/image/uncolorization/users",
			self.basePath);
	})
