...
local function new_us_api(authority, basePath, schemes)
	local schemes_map = {}
...
function us_api:read_user_image_image_uncolorization_users_username_post(username)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
		path = string.format("%s/image/image/uncolorization/users/%s",
