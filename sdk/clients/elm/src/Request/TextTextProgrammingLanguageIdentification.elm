...
module Request.TextTextProgrammingLanguageIdentification exposing (applyTextTextProgrammingLanguageIdentificationPost, getVersionsTextTextProgrammingLanguageIdentificationGet)
...
applyTextTextProgrammingLanguageIdentificationPost :
    ...
    -> Cmd msg
applyTextTextProgrammingLanguageIdentificationPost params =
    Http.request
        { method = "POST"
        , headers = []
        , url = Url.crossOrigin basePath
            ["text", "text", "programming-language-identification"]
...
getVersionsTextTextProgrammingLanguageIdentificationGet :
    ...
    -> Cmd msg
getVersionsTextTextProgrammingLanguageIdentificationGet params =
    Http.request
        { method = "GET"
        , headers = []
        , url = Url.crossOrigin basePath
