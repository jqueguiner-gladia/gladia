...
module Request.TextTextHateSpeechDetection exposing (applyTextTextHateSpeechDetectionPost, getVersionsTextTextHateSpeechDetectionGet)
...
applyTextTextHateSpeechDetectionPost :
    ...
    -> Cmd msg
applyTextTextHateSpeechDetectionPost params =
    Http.request
        { method = "POST"
        , headers = []
...
getVersionsTextTextHateSpeechDetectionGet :
    ...
    -> Cmd msg
getVersionsTextTextHateSpeechDetectionGet params =
    Http.request
        { method = "GET"
        , headers = []
        , url = Url.crossOrigin basePath
