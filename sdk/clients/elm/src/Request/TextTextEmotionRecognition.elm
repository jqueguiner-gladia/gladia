...
module Request.TextTextEmotionRecognition exposing (applyTextTextEmotionRecognitionPost, getVersionsTextTextEmotionRecognitionGet)
...
applyTextTextEmotionRecognitionPost :
    ...
    -> Cmd msg
applyTextTextEmotionRecognitionPost params =
    Http.request
        { method = "POST"
        , headers = []
...
getVersionsTextTextEmotionRecognitionGet :
    ...
    -> Cmd msg
getVersionsTextTextEmotionRecognitionGet params =
    Http.request
        { method = "GET"
        , headers = []
        , url = Url.crossOrigin basePath
