...
module Request.TextTextNextWordPrediction exposing (applyTextTextNextWordPredictionPost, getVersionsTextTextNextWordPredictionGet)
...
applyTextTextNextWordPredictionPost :
    ...
    -> Cmd msg
applyTextTextNextWordPredictionPost params =
    Http.request
        { method = "POST"
        , headers = []
...
getVersionsTextTextNextWordPredictionGet :
    ...
    -> Cmd msg
getVersionsTextTextNextWordPredictionGet params =
    Http.request
        { method = "GET"
        , headers = []
        , url = Url.crossOrigin basePath
