...
module Request.ImageImageUncolorization exposing (applyImageImageUncolorizationPost, getVersionsImageImageUncolorizationGet)
...
applyImageImageUncolorizationPost :
    ...
    -> Cmd msg
applyImageImageUncolorizationPost params =
    Http.request
        { method = "POST"
        , headers = []
...
getVersionsImageImageUncolorizationGet :
    ...
    -> Cmd msg
getVersionsImageImageUncolorizationGet params =
    Http.request
        { method = "GET"
        , headers = []
        , url = Url.crossOrigin basePath
