...
module Request.ImageImageRestoration exposing (applyImageImageRestorationPost, getVersionsImageImageRestorationGet)
...
applyImageImageRestorationPost :
    ...
    -> Cmd msg
applyImageImageRestorationPost params =
    Http.request
        { method = "POST"
        , headers = []
...
getVersionsImageImageRestorationGet :
    ...
    -> Cmd msg
getVersionsImageImageRestorationGet params =
    Http.request
        { method = "GET"
        , headers = []
        , url = Url.crossOrigin basePath
