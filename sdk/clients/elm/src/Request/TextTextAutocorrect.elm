...
module Request.TextTextAutocorrect exposing (applyTextTextAutocorrectPost, getVersionsTextTextAutocorrectGet)
...
applyTextTextAutocorrectPost :
    ...
    -> Cmd msg
applyTextTextAutocorrectPost params =
    Http.request
        { method = "POST"
        , headers = []
...
getVersionsTextTextAutocorrectGet :
    ...
    -> Cmd msg
getVersionsTextTextAutocorrectGet params =
    Http.request
        { method = "GET"
        , headers = []
        , url = Url.crossOrigin basePath
