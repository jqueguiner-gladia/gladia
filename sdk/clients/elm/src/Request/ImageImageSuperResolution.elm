...
module Request.ImageImageSuperResolution exposing (applyImageImageSuperResolutionPost, getVersionsImageImageSuperResolutionGet)
...
applyImageImageSuperResolutionPost :
    ...
    -> Cmd msg
applyImageImageSuperResolutionPost params =
    Http.request
        { method = "POST"
        , headers = []
...
getVersionsImageImageSuperResolutionGet :
    ...
    -> Cmd msg
getVersionsImageImageSuperResolutionGet params =
    Http.request
        { method = "GET"
        , headers = []
        , url = Url.crossOrigin basePath
