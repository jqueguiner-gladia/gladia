...
module Request.ImageImageColorization exposing (applyImageImageColorizationPost, getVersionsImageImageColorizationGet)
...
applyImageImageColorizationPost :
    ...
    -> Cmd msg
applyImageImageColorizationPost params =
    Http.request
        { method = "POST"
        , headers = []
...
getVersionsImageImageColorizationGet :
    ...
    -> Cmd msg
getVersionsImageImageColorizationGet params =
    Http.request
        { method = "GET"
        , headers = []
        , url = Url.crossOrigin basePath
