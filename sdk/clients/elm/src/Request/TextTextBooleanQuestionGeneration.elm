...
module Request.TextTextBooleanQuestionGeneration exposing (applyTextTextBooleanQuestionGenerationPost, getVersionsTextTextBooleanQuestionGenerationGet)
...
applyTextTextBooleanQuestionGenerationPost :
    ...
    -> Cmd msg
applyTextTextBooleanQuestionGenerationPost params =
    Http.request
        { method = "POST"
        , headers = []
...
getVersionsTextTextBooleanQuestionGenerationGet :
    ...
    -> Cmd msg
getVersionsTextTextBooleanQuestionGenerationGet params =
    Http.request
        { method = "GET"
        , headers = []
        , url = Url.crossOrigin basePath
