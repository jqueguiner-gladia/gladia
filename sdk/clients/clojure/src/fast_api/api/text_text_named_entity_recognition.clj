(ns fast-api.api.text-text-named-entity-recognition
...
(defn-spec apply-text-text-named-entity-recognition-post-with-http-info any?
  "Apply model for the named-entity-recognition task for a given models"
  ([] (apply-text-text-named-entity-recognition-post-with-http-info nil))
  ([{:keys [text model]} (s/map-of keyword? any?)]
   (call-api "/text/text/named-entity-recognition/" :post
             {:path-params   {}
              :header-params {}
...
(defn-spec apply-text-text-named-entity-recognition-post any?
  "Apply model for the named-entity-recognition task for a given models"
  ([] (apply-text-text-named-entity-recognition-post nil))
  ([optional-params any?]
   (let [res (:data (apply-text-text-named-entity-recognition-post-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode any? res st/string-transformer)
        res))))


(defn-spec get-versions-text-text-named-entity-recognition-get-with-http-info any?
  "Get list of models available for named-entity-recognition"
  []
  (call-api "/text/text/named-entity-recognition/" :get
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec get-versions-text-text-named-entity-recognition-get any?
  "Get list of models available for named-entity-recognition"
  []
  (let [res (:data (get-versions-text-text-named-entity-recognition-get-with-http-info))]
    (if (:decode-models *api-context*)
       (st/decode any? res st/string-transformer)
       res)))
