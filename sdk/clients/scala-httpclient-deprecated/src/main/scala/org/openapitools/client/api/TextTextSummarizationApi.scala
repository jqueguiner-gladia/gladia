...
class TextTextSummarizationApi(
  ...
  val helper = new TextTextSummarizationApiAsyncHelper(client, config)
   ...
   * @return Any
   */
  def applyTextTextSummarizationPost(text: Option[String] = None, sourceLanguage: Option[String] = None, maxLength: Option[Integer] = None, minLength: Option[Integer] = None, model: Option[String] = None): Option[Any] = {
    val await = Try(Await.result(applyTextTextSummarizationPostAsync(text, sourceLanguage, maxLength, minLength, model), Duration.Inf))
    await match {
   ...
   * @return Future(Any)
   */
  def applyTextTextSummarizationPostAsync(text: Option[String] = None, sourceLanguage: Option[String] = None, maxLength: Option[Integer] = None, minLength: Option[Integer] = None, model: Option[String] = None): Future[Any] = {
      helper.applyTextTextSummarizationPost(text, sourceLanguage, maxLength, minLength, model)
  }
   ...
   * @return Any
   */
  def getVersionsTextTextSummarizationGet(): Option[Any] = {
    val await = Try(Await.result(getVersionsTextTextSummarizationGetAsync(), Duration.Inf))
    await match {
      case Success(i) => Some(await.get)
      case Failure(t) => None
    }
   ...
   * @return Future(Any)
   */
  def getVersionsTextTextSummarizationGetAsync(): Future[Any] = {
      helper.getVersionsTextTextSummarizationGet()
  }

}

class TextTextSummarizationApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {

  def applyTextTextSummarizationPost(text: Option[String] = None,
    sourceLanguage: Option[String] = None,
    maxLength: Option[Integer] = None,
    minLength: Option[Integer] = None,
    model: Option[String] = None
    )(implicit reader: ClientResponseReader[Any]): Future[Any] = {
    // create path and map variables
    val path = (addFmt("/text/text/summarization/"))
    ...
    maxLength match {
      case Some(param) => queryParams += "max_length" -> param.toString
      case _ => queryParams
    }
    minLength match {
      case Some(param) => queryParams += "min_length" -> param.toString
      case _ => queryParams
    }
    model match {
  ...
  def getVersionsTextTextSummarizationGet()(implicit reader: ClientResponseReader[Any]): Future[Any] = {
    // create path and map variables
    val path = (addFmt("/text/text/summarization/"))
