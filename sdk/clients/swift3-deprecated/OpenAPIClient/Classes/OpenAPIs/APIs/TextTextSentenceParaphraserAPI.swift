...
open class TextTextSentenceParaphraserAPI: APIBase {
    /**
     ...
     */
    open class func applyTextTextSentenceParaphraserPost(context: String? = nil, model: Model_applyTextTextSentenceParaphraserPost? = nil, completion: @escaping ((_ data: Any?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getVersionsTextTextSentenceParaphraserGet(completion: @escaping ((_ data: Any?, _ error: ErrorResponse?) -> Void)) {
