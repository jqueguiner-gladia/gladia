...
open class ImageImageRestorationAPI: APIBase {
    /**
     ...
     */
    open class func applyImageImageRestorationPost(image: URL, model: String? = nil, completion: @escaping ((_ data: Any?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getVersionsImageImageRestorationGet(completion: @escaping ((_ data: Any?, _ error: ErrorResponse?) -> Void)) {
