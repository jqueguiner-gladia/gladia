...
open class TextTextLanguageDetectionAPI: APIBase {
    /**
     ...
     */
    open class func applyTextTextLanguageDetectionPost(text: String? = nil, model: Model_applyTextTextLanguageDetectionPost? = nil, completion: @escaping ((_ data: Any?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getVersionsTextTextLanguageDetectionGet(completion: @escaping ((_ data: Any?, _ error: ErrorResponse?) -> Void)) {
