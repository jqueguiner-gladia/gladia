...
class Decoders {
    ...
    private static var __once: () = {
        ...
        // Decoder for [BodyApplyImageImageBackgroundRemovalPost]
        Decoders.addDecoder(clazz: [BodyApplyImageImageBackgroundRemovalPost].self) { (source: AnyObject, instance: AnyObject?) -> Decoded<[BodyApplyImageImageBackgroundRemovalPost]> in
            return Decoders.decode(clazz: [BodyApplyImageImageBackgroundRemovalPost].self, source: source)
        }

        // Decoder for BodyApplyImageImageBackgroundRemovalPost
        Decoders.addDecoder(clazz: BodyApplyImageImageBackgroundRemovalPost.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<BodyApplyImageImageBackgroundRemovalPost> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let _result = instance == nil ? BodyApplyImageImageBackgroundRemovalPost() : instance as! BodyApplyImageImageBackgroundRemovalPost
                ...
                return .failure(.typeMismatch(expected: "BodyApplyImageImageBackgroundRemovalPost", actual: "\(source)"))
            }
        }
        // Decoder for [BodyApplyImageImageColorizationPost]
        Decoders.addDecoder(clazz: [BodyApplyImageImageColorizationPost].self) { (source: AnyObject, instance: AnyObject?) -> Decoded<[BodyApplyImageImageColorizationPost]> in
            return Decoders.decode(clazz: [BodyApplyImageImageColorizationPost].self, source: source)
        }

        // Decoder for BodyApplyImageImageColorizationPost
        Decoders.addDecoder(clazz: BodyApplyImageImageColorizationPost.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<BodyApplyImageImageColorizationPost> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let _result = instance == nil ? BodyApplyImageImageColorizationPost() : instance as! BodyApplyImageImageColorizationPost
                switch Decoders.decodeOptional(clazz: URL.self, source: sourceDictionary["image"] as AnyObject?) {
                ...
                return .failure(.typeMismatch(expected: "BodyApplyImageImageColorizationPost", actual: "\(source)"))
            }
        }
        // Decoder for [BodyApplyImageImageFaceBluringPost]
        Decoders.addDecoder(clazz: [BodyApplyImageImageFaceBluringPost].self) { (source: AnyObject, instance: AnyObject?) -> Decoded<[BodyApplyImageImageFaceBluringPost]> in
            return Decoders.decode(clazz: [BodyApplyImageImageFaceBluringPost].self, source: source)
        }

        // Decoder for BodyApplyImageImageFaceBluringPost
        Decoders.addDecoder(clazz: BodyApplyImageImageFaceBluringPost.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<BodyApplyImageImageFaceBluringPost> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let _result = instance == nil ? BodyApplyImageImageFaceBluringPost() : instance as! BodyApplyImageImageFaceBluringPost
                switch Decoders.decodeOptional(clazz: URL.self, source: sourceDictionary["image"] as AnyObject?) {
        ...
        Decoders.addDecoder(clazz: BodyApplyImageImageSuperResolutionPost.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<BodyApplyImageImageSuperResolutionPost> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let _result = instance == nil ? BodyApplyImageImageSuperResolutionPost() : instance as! BodyApplyImageImageSuperResolutionPost
                switch Decoders.decodeOptional(clazz: URL.self, source: sourceDictionary["image"] as AnyObject?) {
                ...
                return .failure(.typeMismatch(expected: "BodyApplyImageImageSuperResolutionPost", actual: "\(source)"))
            }
        }
        // Decoder for [BodyApplyImageImageUncolorizationPost]
        Decoders.addDecoder(clazz: [BodyApplyImageImageUncolorizationPost].self) { (source: AnyObject, instance: AnyObject?) -> Decoded<[BodyApplyImageImageUncolorizationPost]> in
            return Decoders.decode(clazz: [BodyApplyImageImageUncolorizationPost].self, source: source)
        }

        // Decoder for BodyApplyImageImageUncolorizationPost
        Decoders.addDecoder(clazz: BodyApplyImageImageUncolorizationPost.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<BodyApplyImageImageUncolorizationPost> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let _result = instance == nil ? BodyApplyImageImageUncolorizationPost() : instance as! BodyApplyImageImageUncolorizationPost
                switch Decoders.decodeOptional(clazz: URL.self, source: sourceDictionary["image"] as AnyObject?) {
                ...
                return .failure(.typeMismatch(expected: "BodyApplyImageImageUncolorizationPost", actual: "\(source)"))
            }
        }
        // Decoder for [HTTPValidationError]
        Decoders.addDecoder(clazz: [HTTPValidationError].self) { (source: AnyObject, instance: AnyObject?) -> Decoded<[HTTPValidationError]> in
            return Decoders.decode(clazz: [HTTPValidationError].self, source: source)
        }

        // Decoder for HTTPValidationError
        Decoders.addDecoder(clazz: HTTPValidationError.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<HTTPValidationError> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let _result = instance == nil ? HTTPValidationError() : instance as! HTTPValidationError
                switch Decoders.decodeOptional(clazz: [ValidationError].self, source: sourceDictionary["detail"] as AnyObject?) {
                ...
                return .failure(.typeMismatch(expected: "HTTPValidationError", actual: "\(source)"))
            }
        }
        // Decoder for [ValidationError]
        Decoders.addDecoder(clazz: [ValidationError].self) { (source: AnyObject, instance: AnyObject?) -> Decoded<[ValidationError]> in
        ...
        Decoders.addDecoder(clazz: ValidationError.self) { (source: AnyObject, instance: AnyObject?) -> Decoded<ValidationError> in
            if let sourceDictionary = source as? [AnyHashable: Any] {
                let _result = instance == nil ? ValidationError() : instance as! ValidationError
                switch Decoders.decodeOptional(clazz: [String].self, source: sourceDictionary["loc"] as AnyObject?) {
                
                case let .success(value): _result.loc = value
                case let .failure(error): break
                
                }
                switch Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["msg"] as AnyObject?) {
                
                case let .success(value): _result.msg = value
                case let .failure(error): break
                ...
                return .failure(.typeMismatch(expected: "ValidationError", actual: "\(source)"))
            }
        }
    }()
