...
feature -- API Access
	...
	apply_text_text_keyword_extraction_post (text: STRING_32; model: STRING_32): detachable ANY
			...
			-- 
			-- argument: model  (optional, default to keybert-paraphrase-MiniLM-L6-v2)
			-- 
			-- 
			-- Result ANY
		require
		...
		do
			...
			l_path := "/text/text/keyword-extraction/"
	...
	versions_text_text_keyword_extraction_get : detachable ANY
