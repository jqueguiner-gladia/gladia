...
class
	IMAGEIMAGEBACKGROUNDREMOVAL_API
...
feature -- API Access
	...
	apply_image_image_background_removal_post (image: FILE; model: STRING_32): detachable ANY
		...
		do
			...
			l_path := "/image/image/background-removal/"
	...
	versions_image_image_background_removal_get : detachable ANY
