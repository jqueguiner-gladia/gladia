...
feature -- API Access
	...
	apply_text_text_transliteration_post (text: STRING_32; language: STRING_32; model: STRING_32): detachable ANY
			-- Apply model for the transliteration task for a given models
			-- 
			-- 
			-- argument: text  (optional, default to Лорем ипсум долор сит амет)
			-- 
			-- argument: language  (optional, default to ru)
			-- 
			-- argument: model  (optional, default to transliterate)
			-- 
			-- 
			-- Result ANY
		require
		...
		do
			...
			l_path := "/text/text/transliteration/"
	...
	versions_text_text_transliteration_get : detachable ANY
