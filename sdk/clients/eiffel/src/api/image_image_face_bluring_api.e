...
feature -- API Access
	...
	apply_image_image_face_bluring_post (image: FILE; model: STRING_32): detachable ANY
			-- Apply model for the face-bluring task for a given models
			-- 
			-- 
			-- argument: image  (required)
			-- 
			-- argument: model  (optional, default to ageitgey)
			-- 
			-- 
			-- Result ANY
		require
		...
		do
			...
			l_path := "/image/image/face-bluring/"
	...
	versions_image_image_face_bluring_get : detachable ANY
