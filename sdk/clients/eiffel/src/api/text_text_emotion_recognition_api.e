...
class
	TEXTTEXTEMOTIONRECOGNITION_API
...
feature -- API Access
	...
	apply_text_text_emotion_recognition_post (text: STRING_32; model: STRING_32): detachable ANY
			-- Apply model for the emotion-recognition task for a given models
			-- 
			-- 
			-- argument: text  (optional, default to I like you. I love you)
			-- 
			-- argument: model  (optional, default to mrm8488-t5-base-finetuned-emotion)
			-- 
			-- 
			-- Result ANY
		require
		...
		do
			...
			l_path := "/text/text/emotion-recognition/"
	...
	versions_text_text_emotion_recognition_get : detachable ANY
