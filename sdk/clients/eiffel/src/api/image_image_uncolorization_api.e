...
feature -- API Access
	...
	apply_image_image_uncolorization_post (image: FILE; model: STRING_32): detachable ANY
			-- Apply model for the uncolorization task for a given models
			-- 
			-- 
			-- argument: image  (required)
			-- 
			-- argument: model  (optional, default to v1)
			-- 
			-- 
			-- Result ANY
		require
		...
		do
			...
			l_path := "/image/image/uncolorization/"
	...
	versions_image_image_uncolorization_get : detachable ANY
