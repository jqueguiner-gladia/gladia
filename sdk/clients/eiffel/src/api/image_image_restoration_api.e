...
feature -- API Access
	...
	apply_image_image_restoration_post (image: FILE; model: STRING_32): detachable ANY
			-- Apply model for the restoration task for a given models
			-- 
			-- 
			-- argument: image  (required)
			-- 
			-- argument: model  (optional, default to bringing-old-photos-back-to-life)
			-- 
			-- 
			-- Result ANY
		require
		...
		do
			...
			l_path := "/image/image/restoration/"
	...
	versions_image_image_restoration_get : detachable ANY
