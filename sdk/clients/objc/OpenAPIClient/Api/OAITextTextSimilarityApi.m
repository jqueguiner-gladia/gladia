#import "OAITextTextSimilarityApi.h"
#import "OAIQueryParamCollection.h"
#import "OAIApiClient.h"
#import "OAIHTTPValidationError.h"


@interface OAITextTextSimilarityApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAITextTextSimilarityApi

NSString* kOAITextTextSimilarityApiErrorDomain = @"OAITextTextSimilarityApiErrorDomain";
NSInteger kOAITextTextSimilarityApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) applyTextTextSimilarityPostWithSentence1: (NSString*) sentence1
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/text/text/similarity/"];
