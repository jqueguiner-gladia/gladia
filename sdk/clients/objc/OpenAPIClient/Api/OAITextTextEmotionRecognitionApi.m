#import "OAITextTextEmotionRecognitionApi.h"
#import "OAIQueryParamCollection.h"
#import "OAIApiClient.h"
#import "OAIHTTPValidationError.h"


@interface OAITextTextEmotionRecognitionApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAITextTextEmotionRecognitionApi

NSString* kOAITextTextEmotionRecognitionApiErrorDomain = @"OAITextTextEmotionRecognitionApiErrorDomain";
NSInteger kOAITextTextEmotionRecognitionApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) applyTextTextEmotionRecognitionPostWithText: (NSString*) text
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/text/text/emotion-recognition/"];
