#import "OAITextTextTranslationApi.h"
#import "OAIQueryParamCollection.h"
#import "OAIApiClient.h"
#import "OAIHTTPValidationError.h"


@interface OAITextTextTranslationApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAITextTextTranslationApi

NSString* kOAITextTextTranslationApiErrorDomain = @"OAITextTextTranslationApiErrorDomain";
NSInteger kOAITextTextTranslationApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) applyTextTextTranslationPostWithInputString: (NSString*) inputString
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/text/text/translation/"];
