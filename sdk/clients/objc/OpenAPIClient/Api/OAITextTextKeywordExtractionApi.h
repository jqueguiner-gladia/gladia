...
@interface OAITextTextKeywordExtractionApi: NSObject <OAIApi>

extern NSString* kOAITextTextKeywordExtractionApiErrorDomain;
extern NSInteger kOAITextTextKeywordExtractionApiMissingParamErrorCode;
