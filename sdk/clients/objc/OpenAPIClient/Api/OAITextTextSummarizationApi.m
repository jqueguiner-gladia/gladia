#import "OAITextTextSummarizationApi.h"
#import "OAIQueryParamCollection.h"
#import "OAIApiClient.h"
#import "OAIHTTPValidationError.h"


@interface OAITextTextSummarizationApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAITextTextSummarizationApi

NSString* kOAITextTextSummarizationApiErrorDomain = @"OAITextTextSummarizationApiErrorDomain";
NSInteger kOAITextTextSummarizationApiMissingParamErrorCode = 234513;
...
///
///  @param maxLength  (optional, default to @512)
///
///  @param minLength  (optional, default to @40)
///
///  @param model  (optional, default to @"distilbart-cnn-12-6")
///
///  @returns NSObject*
///
-(NSURLSessionTask*) applyTextTextSummarizationPostWithText: (NSString*) text
    sourceLanguage: (NSString*) sourceLanguage
    maxLength: (NSNumber*) maxLength
    minLength: (NSNumber*) minLength
    model: (NSString*) model
    completionHandler: (void (^)(NSObject* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/text/text/summarization/"];
    ...
    if (sourceLanguage != nil) {
        queryParams[@"source_language"] = sourceLanguage;
    }
    if (maxLength != nil) {
        queryParams[@"max_length"] = maxLength;
    }
    if (minLength != nil) {
        queryParams[@"min_length"] = minLength;
    }
    if (model != nil) {
...
///  @returns NSObject*
///
-(NSURLSessionTask*) getVersionsTextTextSummarizationGetWithCompletionHandler: 
