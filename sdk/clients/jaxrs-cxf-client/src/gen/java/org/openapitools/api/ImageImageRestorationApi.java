...
public interface ImageImageRestorationApi  {
    ...
    @ApiOperation(value = "Apply model for the restoration task for a given models", tags={  })
    @ApiResponses(value = { 
    ...
    public Object applyImageImageRestorationPost( @Multipart(value = "image" ) Attachment imageDetail, @QueryParam("model") @DefaultValue("bringing-old-photos-back-to-life")String model);
    ...
    @Path("/image/image/restoration/")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get list of models available for restoration", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful Response", response = Object.class) })
