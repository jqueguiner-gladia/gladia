...
public interface ImageImageFaceBluringApi  {
    ...
    @ApiOperation(value = "Apply model for the face-bluring task for a given models", tags={  })
    @ApiResponses(value = { 
    ...
    public Object applyImageImageFaceBluringPost( @Multipart(value = "image" ) Attachment imageDetail, @QueryParam("model") @DefaultValue("ageitgey")String model);
    ...
    @Path("/image/image/face-bluring/")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get list of models available for face-bluring", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful Response", response = Object.class) })
