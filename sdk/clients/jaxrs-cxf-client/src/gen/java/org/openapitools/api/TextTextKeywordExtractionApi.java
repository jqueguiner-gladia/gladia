...
public interface TextTextKeywordExtractionApi  {
    ...
    @ApiOperation(value = "Apply model for the keyword-extraction task for a given models", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/text/text/keyword-extraction/")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get list of models available for keyword-extraction", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful Response", response = Object.class) })
