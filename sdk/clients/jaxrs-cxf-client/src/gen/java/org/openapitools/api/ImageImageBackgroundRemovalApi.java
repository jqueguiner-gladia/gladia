...
public interface ImageImageBackgroundRemovalApi  {
    ...
    @ApiOperation(value = "Apply model for the background-removal task for a given models", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/image/image/background-removal/")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get list of models available for background-removal", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful Response", response = Object.class) })
