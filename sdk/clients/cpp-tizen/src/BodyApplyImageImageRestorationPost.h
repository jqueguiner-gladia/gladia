...
class Body_apply_image_image_restoration__post : public Object {
public:
	/*! \brief Constructor.
	 */
	Body_apply_image_image_restoration__post();
	Body_apply_image_image_restoration__post(char* str);

	/*! \brief Destructor.
	 */
	virtual ~Body_apply_image_image_restoration__post();
