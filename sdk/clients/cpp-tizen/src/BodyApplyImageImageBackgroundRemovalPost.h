...
class Body_apply_image_image_background_removal__post : public Object {
public:
	/*! \brief Constructor.
	 */
	Body_apply_image_image_background_removal__post();
	Body_apply_image_image_background_removal__post(char* str);

	/*! \brief Destructor.
	 */
	virtual ~Body_apply_image_image_background_removal__post();
