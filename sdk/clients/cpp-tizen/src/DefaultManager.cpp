...
static bool readUsersImageImageUncolorizationUsersGetProcessor(MemoryStruct_s p_chunk, long code, char* errormsg, void* userData,
	void(* voidHandler)())
{
...
static bool readUsersImageImageUncolorizationUsersGetHelper(char * accessToken,
	...
	, void* userData, bool isAsync)
{
	...
	string url("/image/image/uncolorization/users/");
	int pos;
	...
	if(!isAsync){
		...
		bool retval = readUsersImageImageUncolorizationUsersGetProcessor(*p_chunk, code, errormsg, userData,reinterpret_cast<void(*)()>(handler));
		...
		requestInfo = new(nothrow) RequestInfo (DefaultManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), readUsersImageImageUncolorizationUsersGetProcessor);;
		if(requestInfo == NULL)
			return false;
...
bool DefaultManager::readUsersImageImageUncolorizationUsersGetAsync(char * accessToken,
	
	void(* handler)(std::string, Error, void* )
	, void* userData)
{
	return readUsersImageImageUncolorizationUsersGetHelper(accessToken,
	
	handler, userData, true);
}

bool DefaultManager::readUsersImageImageUncolorizationUsersGetSync(char * accessToken,
