...
export class ImageImageColorizationApi {
    ...
    > {
        let localVarPath = this.basePath + '/image/image/colorization/';
     ...
     */
    public getVersionsImageImageColorizationGet(extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: object;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/image/image/colorization/';
