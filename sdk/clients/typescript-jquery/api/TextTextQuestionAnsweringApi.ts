...
export class TextTextQuestionAnsweringApi {
    ...
    > {
        let localVarPath = this.basePath + '/text/text/question-answering/';
        ...
        if (question !== null && question !== undefined) {
            queryParameters['question'] = <string><any>question;
        }
     ...
     */
    public getVersionsTextTextQuestionAnsweringGet(extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: object;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/text/text/question-answering/';
