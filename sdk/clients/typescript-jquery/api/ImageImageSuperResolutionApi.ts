...
export class ImageImageSuperResolutionApi {
    ...
    > {
        let localVarPath = this.basePath + '/image/image/super-resolution/';
     ...
     */
    public getVersionsImageImageSuperResolutionGet(extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: object;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/image/image/super-resolution/';
