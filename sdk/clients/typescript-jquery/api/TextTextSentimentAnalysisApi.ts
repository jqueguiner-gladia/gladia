...
export class TextTextSentimentAnalysisApi {
    ...
    > {
        let localVarPath = this.basePath + '/text/text/sentiment-analysis/';
     ...
     */
    public getVersionsTextTextSentimentAnalysisGet(extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: object;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/text/text/sentiment-analysis/';
