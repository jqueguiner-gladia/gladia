...
export class TextTextNextWordPredictionApi {
    ...
    > {
        let localVarPath = this.basePath + '/text/text/next-word-prediction/';
     ...
     */
    public getVersionsTextTextNextWordPredictionGet(extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: object;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/text/text/next-word-prediction/';
