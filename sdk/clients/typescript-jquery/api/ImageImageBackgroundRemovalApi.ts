...
export class ImageImageBackgroundRemovalApi {
    ...
    > {
        let localVarPath = this.basePath + '/image/image/background-removal/';
     ...
     */
    public getVersionsImageImageBackgroundRemovalGet(extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: object;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/image/image/background-removal/';
