...
eval {
    my $result = $api_instance->read_users_image_image_uncolorization_users_get();
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DefaultApi->read_users_image_image_uncolorization_users_get: $@\n";
}
