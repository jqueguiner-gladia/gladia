...
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | fast                    |
...
| Fast.Core      | core funcions, config and request types             |
