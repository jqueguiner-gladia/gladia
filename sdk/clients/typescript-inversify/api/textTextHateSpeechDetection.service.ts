...
export class TextTextHateSpeechDetectionService {
     ...
     */
    public applyTextTextHateSpeechDetectionPost(text?: string, model?: string, observe?: 'body', headers?: Headers): Observable<object>;
    public applyTextTextHateSpeechDetectionPost(text?: string, model?: string, observe?: 'response', headers?: Headers): Observable<HttpResponse<object>>;
    public applyTextTextHateSpeechDetectionPost(text?: string, model?: string, observe: any = 'body', headers: Headers = {}): Observable<any> {
