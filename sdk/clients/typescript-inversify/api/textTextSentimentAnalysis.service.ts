...
export class TextTextSentimentAnalysisService {
    ...
    public applyTextTextSentimentAnalysisPost(text?: string, model?: 'nlptown-bert-base-multilingual-uncased-sentiment' | 'distilbert-base-uncased' | 'distilbert-base-uncased-finetuned-sst-2-english' | 'zero-shot-classification-facebook-bart-large-mnli', observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<object>> = this.httpClient.post(`${this.basePath}/text/text/sentiment-analysis/?${queryParameters.join('&')}`, headers);
        if (observe == 'body') {
     ...
     */
    public getVersionsTextTextSentimentAnalysisGet(observe?: 'body', headers?: Headers): Observable<object>;
    public getVersionsTextTextSentimentAnalysisGet(observe?: 'response', headers?: Headers): Observable<HttpResponse<object>>;
    public getVersionsTextTextSentimentAnalysisGet(observe: any = 'body', headers: Headers = {}): Observable<any> {
        headers['Accept'] = 'application/json';

        const response: Observable<HttpResponse<object>> = this.httpClient.get(`${this.basePath}/text/text/sentiment-analysis/`, headers);
        if (observe == 'body') {
               return response.map(httpResponse => <object>(httpResponse.response));
        }
        return response;
