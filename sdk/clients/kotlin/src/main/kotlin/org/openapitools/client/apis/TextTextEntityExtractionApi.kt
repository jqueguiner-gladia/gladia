...
class TextTextEntityExtractionApi(basePath: kotlin.String = "http://localhost") : ApiClient(basePath) {
    ...
    */
    ...
    fun applyTextTextEntityExtractionPost(inputString: kotlin.String?, model: kotlin.String?) : kotlin.Any {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getVersionsTextTextEntityExtractionGet() : kotlin.Any {
        val localVariableBody: kotlin.Any? = null
