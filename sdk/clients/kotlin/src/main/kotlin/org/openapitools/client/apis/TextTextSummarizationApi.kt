...
class TextTextSummarizationApi(basePath: kotlin.String = "http://localhost") : ApiClient(basePath) {
    ...
    */
    ...
    fun applyTextTextSummarizationPost(text: kotlin.String?, sourceLanguage: kotlin.String?, maxLength: kotlin.Int?, minLength: kotlin.Int?, model: kotlin.String?) : kotlin.Any {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf("text" to listOf("$text"), "sourceLanguage" to listOf("$sourceLanguage"), "maxLength" to listOf("$maxLength"), "minLength" to listOf("$minLength"), "model" to listOf("$model"))
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getVersionsTextTextSummarizationGet() : kotlin.Any {
        val localVariableBody: kotlin.Any? = null
