...
class TextTextSentenceParaphraserApi(basePath: kotlin.String = "http://localhost") : ApiClient(basePath) {
    ...
    */
    ...
    fun applyTextTextSentenceParaphraserPost(context: kotlin.String?, model: kotlin.String?) : kotlin.Any {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf("context" to listOf("$context"), "model" to listOf("$model"))
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getVersionsTextTextSentenceParaphraserGet() : kotlin.Any {
        val localVariableBody: kotlin.Any? = null
