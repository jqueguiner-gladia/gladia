...
class ImageImageSuperResolutionApi(basePath: kotlin.String = "http://localhost") : ApiClient(basePath) {
    ...
    */
    ...
    fun applyImageImageSuperResolutionPost(image: java.io.File, model: kotlin.String?) : kotlin.Any {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getVersionsImageImageSuperResolutionGet() : kotlin.Any {
