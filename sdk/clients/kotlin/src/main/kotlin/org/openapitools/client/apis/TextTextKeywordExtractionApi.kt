...
class TextTextKeywordExtractionApi(basePath: kotlin.String = "http://localhost") : ApiClient(basePath) {
    ...
    */
    ...
    fun applyTextTextKeywordExtractionPost(text: kotlin.String?, model: kotlin.String?) : kotlin.Any {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getVersionsTextTextKeywordExtractionGet() : kotlin.Any {
        val localVariableBody: kotlin.Any? = null
