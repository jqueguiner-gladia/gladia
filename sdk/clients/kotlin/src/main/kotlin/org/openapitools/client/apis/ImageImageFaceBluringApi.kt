...
class ImageImageFaceBluringApi(basePath: kotlin.String = "http://localhost") : ApiClient(basePath) {
    ...
    */
    ...
    fun applyImageImageFaceBluringPost(image: java.io.File, model: kotlin.String?) : kotlin.Any {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getVersionsImageImageFaceBluringGet() : kotlin.Any {
