...
class TextTextNamedEntityRecognitionApi(basePath: kotlin.String = "http://localhost") : ApiClient(basePath) {
    ...
    */
    ...
    fun applyTextTextNamedEntityRecognitionPost(text: kotlin.String?, model: kotlin.String?) : kotlin.Any {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getVersionsTextTextNamedEntityRecognitionGet() : kotlin.Any {
        val localVariableBody: kotlin.Any? = null
