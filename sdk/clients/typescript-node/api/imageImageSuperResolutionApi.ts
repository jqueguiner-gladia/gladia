...
export enum ImageImageSuperResolutionApiApiKeys {
}
...
export class ImageImageSuperResolutionApi {
    ...
    public setApiKey(key: ImageImageSuperResolutionApiApiKeys, value: string) {
        (this.authentications as any)[ImageImageSuperResolutionApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async getVersionsImageImageSuperResolutionGet (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
        const localVarPath = this.basePath + '/image/image/super-resolution/';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
