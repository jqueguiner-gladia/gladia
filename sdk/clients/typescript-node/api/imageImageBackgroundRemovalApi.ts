...
export enum ImageImageBackgroundRemovalApiApiKeys {
}

export class ImageImageBackgroundRemovalApi {
    ...
    public setApiKey(key: ImageImageBackgroundRemovalApiApiKeys, value: string) {
        (this.authentications as any)[ImageImageBackgroundRemovalApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async getVersionsImageImageBackgroundRemovalGet (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
        const localVarPath = this.basePath + '/image/image/background-removal/';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
