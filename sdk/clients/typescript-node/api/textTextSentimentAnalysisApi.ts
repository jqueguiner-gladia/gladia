...
export enum TextTextSentimentAnalysisApiApiKeys {
}

export class TextTextSentimentAnalysisApi {
    ...
    public setApiKey(key: TextTextSentimentAnalysisApiApiKeys, value: string) {
        (this.authentications as any)[TextTextSentimentAnalysisApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async getVersionsTextTextSentimentAnalysisGet (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
        const localVarPath = this.basePath + '/text/text/sentiment-analysis/';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
