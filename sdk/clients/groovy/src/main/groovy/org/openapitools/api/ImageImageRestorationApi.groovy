...
class ImageImageRestorationApi {
    ...
    def applyImageImageRestorationPost ( File image, String model, Closure onSuccess, Closure onFailure)  {
        String resourcePath = "/image/image/restoration/"
    ...
    def getVersionsImageImageRestorationGet ( Closure onSuccess, Closure onFailure)  {
        String resourcePath = "/image/image/restoration/"
