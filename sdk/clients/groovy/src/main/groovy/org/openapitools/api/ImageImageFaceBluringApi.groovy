...
class ImageImageFaceBluringApi {
    ...
    def applyImageImageFaceBluringPost ( File image, String model, Closure onSuccess, Closure onFailure)  {
        String resourcePath = "/image/image/face-bluring/"
    ...
    def getVersionsImageImageFaceBluringGet ( Closure onSuccess, Closure onFailure)  {
        String resourcePath = "/image/image/face-bluring/"
