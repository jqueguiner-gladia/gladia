...
class ImageImageUncolorizationApi {
    ...
    def applyImageImageUncolorizationPost ( File image, String model, Closure onSuccess, Closure onFailure)  {
        String resourcePath = "/image/image/uncolorization/"
    ...
    def getVersionsImageImageUncolorizationGet ( Closure onSuccess, Closure onFailure)  {
        String resourcePath = "/image/image/uncolorization/"
