...
class ImageImageSuperResolutionApi {
    ...
    def applyImageImageSuperResolutionPost ( File image, String model, Closure onSuccess, Closure onFailure)  {
        String resourcePath = "/image/image/super-resolution/"
    ...
    def getVersionsImageImageSuperResolutionGet ( Closure onSuccess, Closure onFailure)  {
        String resourcePath = "/image/image/super-resolution/"
