...
class ImageImageColorizationApi {
    ...
    def applyImageImageColorizationPost ( File image, String model, Closure onSuccess, Closure onFailure)  {
        String resourcePath = "/image/image/colorization/"
    ...
    def getVersionsImageImageColorizationGet ( Closure onSuccess, Closure onFailure)  {
        String resourcePath = "/image/image/colorization/"
