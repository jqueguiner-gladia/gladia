...
#include <stdio.h>
#include <ctype.h>
#include "TextTextLanguageDetectionAPI.h"
...
TextTextLanguageDetectionAPI_applyTextTextLanguageDetectionPost(apiClient_t *apiClient ,char * text ,model_e model)
{
    ...
    // create the path
    long sizeOfPath = strlen("/text/text/language-detection/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/text/text/language-detection/");
    ...
    cJSON *TextTextLanguageDetectionAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    object_t *elementToReturn = object_parseFromJSON(TextTextLanguageDetectionAPIlocalVarJSON);
    cJSON_Delete(TextTextLanguageDetectionAPIlocalVarJSON);
