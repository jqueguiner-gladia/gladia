...
#include <stdio.h>
#include <ctype.h>
#include "ImageImageRestorationAPI.h"
...
ImageImageRestorationAPI_applyImageImageRestorationPost(apiClient_t *apiClient ,binary_t* image ,char * model)
{
    ...
    // create the path
    long sizeOfPath = strlen("/image/image/restoration/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/image/image/restoration/");
    ...
    cJSON *ImageImageRestorationAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    object_t *elementToReturn = object_parseFromJSON(ImageImageRestorationAPIlocalVarJSON);
    cJSON_Delete(ImageImageRestorationAPIlocalVarJSON);
