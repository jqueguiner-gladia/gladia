...
#include <stdio.h>
#include <ctype.h>
#include "ImageImageBackgroundRemovalAPI.h"
...
ImageImageBackgroundRemovalAPI_applyImageImageBackgroundRemovalPost(apiClient_t *apiClient ,binary_t* image ,model_e model)
{
    ...
    // create the path
    long sizeOfPath = strlen("/image/image/background-removal/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/image/image/background-removal/");
    ...
    cJSON *ImageImageBackgroundRemovalAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    object_t *elementToReturn = object_parseFromJSON(ImageImageBackgroundRemovalAPIlocalVarJSON);
    cJSON_Delete(ImageImageBackgroundRemovalAPIlocalVarJSON);
