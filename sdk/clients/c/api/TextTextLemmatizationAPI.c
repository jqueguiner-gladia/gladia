...
#include <stdio.h>
#include <ctype.h>
#include "TextTextLemmatizationAPI.h"
...
//
object_t*
TextTextLemmatizationAPI_applyTextTextLemmatizationPost(apiClient_t *apiClient ,char * sentence ,model_e model)
{
    ...
    // create the path
    long sizeOfPath = strlen("/text/text/lemmatization/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/text/text/lemmatization/");
    ...
    cJSON *TextTextLemmatizationAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    object_t *elementToReturn = object_parseFromJSON(TextTextLemmatizationAPIlocalVarJSON);
    cJSON_Delete(TextTextLemmatizationAPIlocalVarJSON);
...
//
object_t*
TextTextLemmatizationAPI_getVersionsTextTextLemmatizationGet(apiClient_t *apiClient)
{
