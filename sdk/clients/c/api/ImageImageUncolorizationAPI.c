...
#include <stdio.h>
#include <ctype.h>
#include "ImageImageUncolorizationAPI.h"
...
ImageImageUncolorizationAPI_applyImageImageUncolorizationPost(apiClient_t *apiClient ,binary_t* image ,model_e model)
{
    ...
    // create the path
    long sizeOfPath = strlen("/image/image/uncolorization/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/image/image/uncolorization/");
    ...
    cJSON *ImageImageUncolorizationAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    object_t *elementToReturn = object_parseFromJSON(ImageImageUncolorizationAPIlocalVarJSON);
    cJSON_Delete(ImageImageUncolorizationAPIlocalVarJSON);
