...
#include <stdio.h>
#include <ctype.h>
#include "TextTextProgrammingLanguageIdentificationAPI.h"
...
TextTextProgrammingLanguageIdentificationAPI_applyTextTextProgrammingLanguageIdentificationPost(apiClient_t *apiClient ,char * text ,char * model)
{
    ...
    // create the path
    long sizeOfPath = strlen("/text/text/programming-language-identification/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/text/text/programming-language-identification/");
    ...
    cJSON *TextTextProgrammingLanguageIdentificationAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    object_t *elementToReturn = object_parseFromJSON(TextTextProgrammingLanguageIdentificationAPIlocalVarJSON);
    cJSON_Delete(TextTextProgrammingLanguageIdentificationAPIlocalVarJSON);
