...
#include <stdio.h>
#include <ctype.h>
#include "TextTextNextWordPredictionAPI.h"
...
TextTextNextWordPredictionAPI_applyTextTextNextWordPredictionPost(apiClient_t *apiClient ,char * sentence ,model_e model)
{
    ...
    // create the path
    long sizeOfPath = strlen("/text/text/next-word-prediction/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/text/text/next-word-prediction/");
    ...
    cJSON *TextTextNextWordPredictionAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    object_t *elementToReturn = object_parseFromJSON(TextTextNextWordPredictionAPIlocalVarJSON);
    cJSON_Delete(TextTextNextWordPredictionAPIlocalVarJSON);
