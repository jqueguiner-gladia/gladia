...
#include <stdio.h>
#include <ctype.h>
#include "TextTextKeywordExtractionAPI.h"
...
TextTextKeywordExtractionAPI_applyTextTextKeywordExtractionPost(apiClient_t *apiClient ,char * text ,model_e model)
{
    ...
    // create the path
    long sizeOfPath = strlen("/text/text/keyword-extraction/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/text/text/keyword-extraction/");
    ...
    cJSON *TextTextKeywordExtractionAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    object_t *elementToReturn = object_parseFromJSON(TextTextKeywordExtractionAPIlocalVarJSON);
    cJSON_Delete(TextTextKeywordExtractionAPIlocalVarJSON);
