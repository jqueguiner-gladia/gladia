...
#include <stdio.h>
#include <ctype.h>
#include "TextTextHateSpeechDetectionAPI.h"
...
TextTextHateSpeechDetectionAPI_applyTextTextHateSpeechDetectionPost(apiClient_t *apiClient ,char * text ,char * model)
{
    ...
    // create the path
    long sizeOfPath = strlen("/text/text/hate-speech-detection/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/text/text/hate-speech-detection/");
    ...
    cJSON *TextTextHateSpeechDetectionAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    object_t *elementToReturn = object_parseFromJSON(TextTextHateSpeechDetectionAPIlocalVarJSON);
    cJSON_Delete(TextTextHateSpeechDetectionAPIlocalVarJSON);
