...
open class ImageImageUncolorizationAPI {
    /**
    ...
    /**
     ...
     - parameter model: (query)  (optional, default to .v1)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func applyImageImageUncolorizationPost(image: URL, model: Model_applyImageImageUncolorizationPost? = nil, completion: @escaping ((_ data: Any?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getVersionsImageImageUncolorizationGet(completion: @escaping ((_ data: Any?,_ error: Error?) -> Void)) {
