...
open class TextTextLemmatizationAPI {
    /**
    ...
    /**
     ...
     - parameter sentence: (query)  (optional, default to "My name is Clara and I live in Berkeley.")
     - parameter model: (query)  (optional, default to .wordnet)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func applyTextTextLemmatizationPost(sentence: String? = nil, model: Model_applyTextTextLemmatizationPost? = nil, completion: @escaping ((_ data: Any?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getVersionsTextTextLemmatizationGet(completion: @escaping ((_ data: Any?,_ error: Error?) -> Void)) {
