...
open class TextTextSummarizationAPI {
    /**
    ...
    /**
     ...
     - parameter maxLength: (query)  (optional, default to 512)
     - parameter minLength: (query)  (optional, default to 40)
     - parameter model: (query)  (optional, default to .distilbart-cnn-12-6)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func applyTextTextSummarizationPost(text: String? = nil, sourceLanguage: String? = nil, maxLength: Int? = nil, minLength: Int? = nil, model: Model_applyTextTextSummarizationPost? = nil, completion: @escaping ((_ data: Any?,_ error: Error?) -> Void)) {
     ...
     */
    open class func applyTextTextSummarizationPostWithRequestBuilder(text: String? = nil, sourceLanguage: String? = nil, maxLength: Int? = nil, minLength: Int? = nil, model: Model_applyTextTextSummarizationPost? = nil) -> RequestBuilder<Any> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getVersionsTextTextSummarizationGet(completion: @escaping ((_ data: Any?,_ error: Error?) -> Void)) {
