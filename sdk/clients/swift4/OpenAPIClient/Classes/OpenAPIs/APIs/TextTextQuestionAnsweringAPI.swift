...
open class TextTextQuestionAnsweringAPI {
    /**
    ...
    /**
     ...
     - parameter context: (query)  (optional, default to "My name is Clara and I live in Berkeley.")
     - parameter question: (query)  (optional, default to "What's my name?")
     - parameter model: (query)  (optional, default to .deepset_bert-base-cased-squad2)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func applyTextTextQuestionAnsweringPost(context: String? = nil, question: String? = nil, model: Model_applyTextTextQuestionAnsweringPost? = nil, completion: @escaping ((_ data: Any?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getVersionsTextTextQuestionAnsweringGet(completion: @escaping ((_ data: Any?,_ error: Error?) -> Void)) {
