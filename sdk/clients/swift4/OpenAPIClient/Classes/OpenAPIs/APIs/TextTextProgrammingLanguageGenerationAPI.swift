...
open class TextTextProgrammingLanguageGenerationAPI {
    /**
    ...
    /**
     ...
     - parameter codeSnippet: (query)  (optional, default to "def is_palendrome(s):")
     - parameter model: (query)  (optional, default to .sentdex-GPyT)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func applyTextTextProgrammingLanguageGenerationPost(codeSnippet: String? = nil, model: Model_applyTextTextProgrammingLanguageGenerationPost? = nil, completion: @escaping ((_ data: Any?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getVersionsTextTextProgrammingLanguageGenerationGet(completion: @escaping ((_ data: Any?,_ error: Error?) -> Void)) {
