...
def generate_abstractive_summary(summarization_model: pipeline, text: str, type: str, min_len: int=120, max_len: int=512 , **kwargs):
  """
...
def predict(text: str, source_language: str="eng", min_length: int=120, max_length: int=512):
  """
